...
export default class LoadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(
            "tilesheet",
            "https://d1w49crlcpe45.cloudfront.net/tilemap/tilemap.png"
        );
        // load tilemap
        ...
        this.load.atlas(
            "black-bird",
            "https://d1w49crlcpe45.cloudfront.net/sprites/black-bird-spritesheet.png",
            "https://d1w49crlcpe45.cloudfront.net/sprites/black-bird-atlas.json"
        );
        // load explosions
        this.load.atlas(
            "explosion",
        ...
        this.load.on("complete", () => {
            ...
            // blackbird animations
            this.anims.create({
                key: "black-bird-fly",
                frames: this.anims.generateFrameNames("black-bird", {
                    prefix: "fly_",
                    start: 1,
                    end: 8,
                }),
            ...
            if (this.routerUrl === "/train") {
                this.registry.set("train", true);
                this.registry.set("iterCount", 0);
                this.registry.set("generation", 0);
